...
class _SettingsState extends State<Settings> {
  ...
  void initState() {
    ...
    if (_sliderValue == 0.0) {
      ...
      if (currentNotificationVolume != null &&
        ...
        setState(() {
          _sliderValue = currentNotificationVolume!; // Use the current volume as the initial value
        });
      } else {
        setState(() {
          _sliderValue = maxNotificationVolume; // Set the slider to the maximum if the current volume exceeds the range
        });
      }
    }
  ...
  Future<void> _initVolume() async {
    ...
    VolumeController().listener((volume) {
      setState(() {
        ...
        _setVolumeValue = volume; // Update the slider value to reflect the system's volume
      });
    });
  }
  ...
  Future<void> updateNotificationVolumes() async {
    ...
    currentNotificationVolume = await Volume.getVol ?? 0.0; // Provide a default value if currentNotificationVolume is null
    setState(() {});
  }
  ...
  void setNotificationVolume(double volume) async {
    if (volume >= 0 && volume <= maxNotificationVolume) {
      setState(() {
        ...
        currentNotificationVolume = volume; // Update current notification volume
      });
  ...
  void playAlarm() {
    ...
    if (pro.selectedRingtonePath != null && pro.selectedRingtonePath!.isNotEmpty) {
  ...
  void toggleRingOnSilent(bool value) async {
      setState(() {
        controller.ringOnSilentSwitch.value = value; // Update the local state immediately
      });
  ...
  Future<void> loadSettings() async {
    ...
    controller.vibrationSwitch.value = prefs.getBool("vibrateOnSilent")?? false;
    controller.ringOnSilentSwitch.value = prefs.getBool('ringOnSilent') ?? false;
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(top: screenWidth * 0.05, right: screenWidth * 0.05, left: screenWidth * 0.05),
                  child: ClipRRect(
                                ...
                                child: Obx(() {
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      setState(() {
                                        controller.temperature.value = !controller.temperature.value;
                                        // Additional logic or state management as required
                                      });
                                    },
                                    child: Padding(
                                      padding: EdgeInsets.all(screenWidth * 0.0185),
                                      child: ToggleSwitch(
                                        minHeight: 20,
                                        minWidth: 35.0,
                                        cornerRadius: 20.0,
                                        activeBgColors: [[themeColor!], [themeColor!]],
                                        activeFgColor: Colors.white,
                                        inactiveBgColor: Colors.black,
                                        inactiveFgColor: Colors.white,
                                        initialLabelIndex: controller.temperature.value ? 1 : 0,
                                        totalSwitches: 2,
                                        labels: ['C', 'F'],
                                        radiusStyle: true,
                                        onToggle: (index) {
                                ...
                                Expanded(
                                  child: Slider(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      setState(() {
                                        _sliderValue = value; // Update _sliderValue directly
                                      });
                                      setNotificationVolume(value.toDouble());// Update notification volume when slider changes
                                    },
                                    value: _sliderValue,
                                    activeColor: themeColor,
                              ...
                              Align(
                                ...
                                child: Obx(() {
                                  return Transform.scale(
                                    scale: 0.6,
                                    child: Switch(
                                      onChanged: toggleRingOnSilent,
                                      value: controller.ringOnSilentSwitch.value,
                                      activeColor: themeColor,
                                      activeTrackColor: textColor,
                                      inactiveThumbColor: linesColor,
                                      inactiveTrackColor: textColor,
                              ...
                              Obx(() {
                                return Align(
                                  ...
                                  child: Transform.scale(
                                    scale: 0.6,
                                    child: Switch(
                                      onChanged: toggleVibrateOnSilent,
                      ...
                      child: Card(
                        ...
                        child: Column(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) =>  CustomRateDialog(rateMyApp: widget.rateMyApp,)));
                              },
                              child: Padding(
                                padding: EdgeInsets.only(
                                    left: leftMargin,
        ...
        children: [
          ...
          Center(
            child: AutoSizeText(
              ...
              style: TextStyle(color: textColor, fontSize: 10), // Set content text color
            maxLines: 2,
            ),
          ),
          SizedBox(height: screenHeight * 0.012,),
